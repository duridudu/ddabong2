...
class LogoutModalViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        // 아이콘
        let iconImageView = UIImageView(image: UIImage(named: "logout")) // 로그아웃 아이콘
        ...
        confirmButton.backgroundColor = UIColor(red: 1.0, green: 91/255, blue: 53/255, alpha: 1.0) // 주황색 FF5B35
